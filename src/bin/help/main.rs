...
fn main() {
    ...
    let args = Command::new("help")
        .override_help(default_help.as_str())
...
const BROADCAST_HELP: Help = Help {
    cmd: "sdk broadcast",
...
const SELFUPDATE_HELP: Help = Help {
    cmd: "sdk selfupdate",
...
const UNINSTALL_HELP: Help = Help {
    cmd: "sdk uninstall",
